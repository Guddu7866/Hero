...
async def useradd(_, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/1400131ce33375525b697.jpg",
        caption=f"""**━━━━━━━━━━━━━━━━━━━━━━━━
💥 ʜᴇʟʟᴏ, ɪ ᴀᴍ ʙʀᴏᴋᴇɴ ᴍʀ ᴢ ᴍᴜsɪᴄ sᴜᴘᴇʀ ғᴀsᴛ ᴠᴄ ᴘʟᴀʏᴇʀ
ʙᴏᴛ ғᴏʀ ᴛᴇʟᴇɢʀᴀᴍ ɢʀᴏᴜᴘs🌼 ..
┏━━━━━━━━━━━━━━━━━┓
┣★ ᴋɪɴɢ    : [BROKEN MR Z](https://t.me/iam_your_heart4)
┗━━━━━━━━━━━━━━━━━┛
💞 Type /help to others commands ɪғ ʏᴏᴜ ʜᴀᴠᴇ ᴀɴʏ ǫᴜᴇsᴛɪᴏɴs ᴛʜᴇɴ
    ...
    await message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "💥 𝘾𝙊𝙉𝙏𝘼𝘾𝙏 𝙊𝙒𝙉𝙀𝙍 💞", url=f"https://github.com/guddu7866/Hero")
                ]
            ]
        ),
    )
